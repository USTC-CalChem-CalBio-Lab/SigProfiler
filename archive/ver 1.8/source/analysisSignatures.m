function analysisSignatures(inputFolder, outputFolder, inputFile, minSignatures, maxSignatures, iterationsPerCore, totalCores) 

     %% Reading input file
       input = load([ inputFolder filesep inputFile]);
     ...
     for i = minSignatures : maxSignatures
        ...
        [input, allProcesses, allExposures, idx, processes, exposures, processStab, processStabAvg] = ...
            decipherMutationalProcesses(iterationsPerCore, totalSignatures, input, outputFileNameFull, outputFileNameSkinny, totalCores);
