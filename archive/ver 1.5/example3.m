...
%% Define parameters
outputFileName = 'res_example_1_21_WTSI_BRCA_whole_genome_substitutions.mat';
inputFolder  = 'output';
if ( exist([inputFolder filesep outputFileName], 'file') == 0)
   disp(['File ' [inputFolder filesep outputFileName] ' cannot be found! Please run example1.m prior to running example3.m!']);
   return;
end

%% Loading the data
load([inputFolder filesep outputFileName]);
