function import_dinuc_mutation_types(inputFile, templateFolder, outputFile)

mutationTypeColumns = 2;
input = readtable( inputFile,'ReadVariableNames',false);
        columnNames = input{1,:};
input(1,:) = [];
output = load([templateFolder filesep 'dinuc_template.mat']);
