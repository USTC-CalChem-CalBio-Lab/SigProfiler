...
annotation(f1,'textbox',...
    ...
    'String',{[num2str(size(input.sampleNames, 1)) ' ' cancerType{1} ' samples'], [ThousandSep(sum(sum(input.originalGenomes))) ' mutations'], ['Stability ' num2str(round(processStabAvg(i)*100)/100)]},...
